...
_array = ["milgp_v_mmac_hgunner_belt_KHK", "milgp_v_mmac_hgunner_KHK", "milgp_v_jpc_hgunner_khk", "milgp_v_jpc_hgunner_belt_khk"];
_vest = selectRandom _array;
player addVest _vest;
for "_i" from 1 to 6 do {player addItemToVest "rhsgref_50Rnd_792x57_SmK_alltracers_drum";};
