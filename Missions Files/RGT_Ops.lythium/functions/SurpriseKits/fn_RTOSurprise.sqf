...
comment "Add weapons";
_array = ["rhs_weap_mk18_d", "rhs_weap_m4a1_d", "rhs_weap_m4a1_blockII_KAC_d"];
...
_optic = ["rhsusf_acc_eotech_552", 0.25, "rhsusf_acc_compm4", 0.25, "rhsusf_acc_T1_high", 0.20, "rhsusf_acc_eotech_xps3", 0.25, "rhsusf_acc_g33_xps3_tan", 0.05] call BIS_fnc_selectRandomWeighted;
