...
comment "Add weapons";
player addWeapon "rhs_weap_vss_grip";
...
_array = ["milgp_v_mmac_marksman_belt_KHK", "milgp_v_mmac_marksman_KHK", "milgp_v_jpc_Marksman_khk", "milgp_v_jpc_marksman_belt_khk"];
...
player addBackpack "milgp_bp_Tomahawk_khk";
for "_i" from 1 to 10 do {player addItemToVest "rhs_20rnd_9x39mm_SP5";};
