...
comment "Add weapons";
_rifle = ["rhs_weap_m249_pip_S_vfg1", 0.40, "rhs_weap_minimi_para_railed", 0.20, "rhs_weap_m249", 0.20, "rhs_weap_m249_pip", 0.20] call BIS_fnc_selectRandomWeighted;
player addWeapon _rifle;
_optic = ["rhsusf_acc_ELCAN_ard", 0.50, "rhsusf_acc_su230", 0.25, "rhsusf_acc_su230_mrds", 0.25] call BIS_fnc_selectRandomWeighted;
if (("rhs_weap_m249_pip_S_vfg1" isEqualTo _rifle) or ("rhs_weap_minimi_para_railed" isEqualTo _rifle)) then {
