...
_vest = ["milgp_v_mmac_medic_belt_cb", "milgp_v_mmac_medic_cb", "milgp_v_jpc_Medic_cb", "milgp_v_jpc_medic_belt_cb", "USP_CRYE_CPC_MEDIC", "USP_CRYE_CPC_MEDIC_BELT"] call BIS_fnc_selectRandom;
