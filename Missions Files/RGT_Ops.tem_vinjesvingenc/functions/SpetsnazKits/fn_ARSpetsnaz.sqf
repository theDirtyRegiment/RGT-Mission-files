...
comment "Add weapons";
_rifle = ["rhs_weap_akm_zenitco01_b33", "rhs_weap_ak103_zenitco01_b33", "rhs_weap_ak104_zenitco01_b33"] call BIS_fnc_selectRandom;
player addWeapon _rifle;
_optic = ["rhs_acc_1p87", "rhsusf_acc_eotech_552", "rhs_acc_ekp8_18"] call BIS_fnc_selectRandom;
...
_vest = ["milgp_v_marciras_hgunner_belt_rgr", "milgp_v_marciras_hgunner_rgr"] call BIS_fnc_selectRandom;
player addVest _vest;
_bag = ["rhs_assault_umbts", "USP_45L_RUCKSACK"] call BIS_fnc_selectRandom;
