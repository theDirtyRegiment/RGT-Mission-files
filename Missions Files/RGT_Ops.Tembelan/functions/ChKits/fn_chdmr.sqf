...
if (_rifle isEqualTo "rhs_weap_sr25_ec") then { 
...
_array = ["milgp_v_mmac_teamleader_belt_cb", "milgp_v_mmac_teamleader_cb", "milgp_v_jpc_TeamLeader_cb", "milgp_v_jpc_teamleader_belt_cb"];
_vest = selectRandom _array;
player addVest _vest;
_array = ["milgp_bp_Pointman_cb", "USP_ZIPON_PANEL_CBR"];
