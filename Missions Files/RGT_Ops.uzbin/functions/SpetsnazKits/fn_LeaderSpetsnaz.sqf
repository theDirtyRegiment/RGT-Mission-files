...
_optic = ["rhs_acc_1p87", "rhsusf_acc_eotech_552", "rhs_acc_ekp8_18", "rhs_acc_rakurspm"] call BIS_fnc_selectRandom;
...
_vest = ["milgp_v_marciras_teamleader_belt_rgr", "milgp_v_marciras_teamleader_rgr"] call BIS_fnc_selectRandom;
