...
comment "Add weapons";
_rifle = ["rhs_weap_ak74m_zenitco01_afg", "rhs_weap_ak105_zenitco01"] call BIS_fnc_selectRandom;
...
_vest = ["milgp_v_marciras_medic_belt_rgr", "milgp_v_marciras_medic_rgr"] call BIS_fnc_selectRandom;
