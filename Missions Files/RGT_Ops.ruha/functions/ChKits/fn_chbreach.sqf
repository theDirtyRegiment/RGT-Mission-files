...
_vest = ["milgp_v_mmac_assaulter_belt_cb", "milgp_v_mmac_assaulter_cb", "milgp_v_jpc_Assaulter_cb", "milgp_v_jpc_assaulter_belt_cb", "USP_CRYE_NCPC_ASLT", "USP_EAGLE_MBAV_LOAD", "USP_VEST_STRANDHOGG2_CBR", "USP_VEST_PLATEFRAME_LOAD2_TAN"] call BIS_fnc_selectRandom;
