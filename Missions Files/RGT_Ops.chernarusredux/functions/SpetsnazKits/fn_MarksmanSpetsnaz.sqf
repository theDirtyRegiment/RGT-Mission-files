...
comment "Add weapons";
_rifle = ["rhs_weap_svdp_wd", "rhs_weap_svds"] call BIS_fnc_selectRandom;
player addWeapon _rifle;
_muzzle = ["rhs_acc_tgpv", 0.33, "rhs_acc_tgpv2", 0.33, "", 0.33] call BIS_fnc_selectRandomWeighted;
...
_vest = ["milgp_v_marciras_marksman_belt_rgr", "milgp_v_marciras_marksman_rgr"] call BIS_fnc_selectRandom;
