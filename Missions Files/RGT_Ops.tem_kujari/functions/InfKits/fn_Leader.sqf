...
_vest = ["rhsusf_spcs_ocp_teamleader_alt", "rhsusf_spcs_ocp_squadleader", "rhsusf_spcs_ocp_teamleader", "milgp_v_marciras_teamleader_mc", "milgp_v_marciras_teamleader_belt_mc"] call BIS_fnc_selectRandom;
