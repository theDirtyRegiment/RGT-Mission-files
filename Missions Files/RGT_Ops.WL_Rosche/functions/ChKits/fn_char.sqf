...
comment "Add weapons";
_array = ["rhs_weap_minimi_para_railed", "rhs_weap_m249_pip_S_vfg1", "rhs_weap_m249_pip_S"];
_rifle = selectRandom _array;
player addWeapon _rifle;
player addPrimaryWeaponItem "rhsusf_acc_anpeq16a";
_optic = ["", 0.75, "rhsusf_acc_eotech_xps3", 0.25, "rhsusf_acc_g33_xps3", 0.25] call BIS_fnc_selectRandomWeighted;
player addPrimaryWeaponItem _optic;
player addPrimaryWeaponItem "rhsusf_acc_grip1";
player addWeapon "hgun_Pistol_heavy_01_F";
player addHandgunItem "acc_flashlight_pistol";
player addHandgunItem "11Rnd_45ACP_Mag";
_array = ["optic_mrd", "optic_mrd_black"];
_optic1 = selectRandom _array;
...
_array = ["milgp_v_mmac_hgunner_belt_cb", "milgp_v_mmac_hgunner_cb", "milgp_v_jpc_hgunner_cb", "milgp_v_jpc_hgunner_belt_cb"];
