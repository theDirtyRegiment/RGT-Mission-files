...
comment "Add weapons";
_rifle = ["rhs_weap_minimi_para_railed", "rhs_weap_m249_pip_S_vfg1", "rhs_weap_m249_pip_S"]call BIS_fnc_selectRandom;
...
_vest = ["milgp_v_mmac_hgunner_belt_cb", "milgp_v_mmac_hgunner_cb", "milgp_v_jpc_hgunner_cb", "milgp_v_jpc_hgunner_belt_cb"] call BIS_fnc_selectRandom;
