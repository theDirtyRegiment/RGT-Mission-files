...
_optic = ["rhsusf_acc_eotech_552", 0.25, "rhsusf_acc_T1_high", 0.20, "rhsusf_acc_eotech_xps3", 0.20, "rhsusf_acc_su230a", 0.10] call BIS_fnc_selectRandomWeighted;
...
for "_i" from 1 to 4 do {player addItem "rhs_mag_30Rnd_556x45_Mk318_PMAG";};
