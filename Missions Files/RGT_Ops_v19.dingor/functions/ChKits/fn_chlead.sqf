...
_array = ["milgp_v_mmac_teamleader_belt_cb", "milgp_v_mmac_teamleader_cb", "milgp_v_jpc_TeamLeader_cb", "milgp_v_jpc_teamleader_belt_cb", "USP_CRYE_CPC_LEAD_BELT", "USP_CRYE_CPC_LEAD", "USP_VEST_STRANDHOGG2_CBR", "USP_VEST_PLATEFRAME_LOAD2_TAN"];
