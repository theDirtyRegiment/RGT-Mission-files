...
comment "Add weapons";
_array = ["rhs_weap_vss_grip", "rhs_weap_asval_grip"];
_rifle = selectRandom _array;
player addWeapon _rifle;
player addPrimaryWeaponItem "rhs_acc_perst1ik_ris";
_array = ["rhs_acc_ekp1", "rhs_acc_ekp8_02", "rhs_acc_pkas"];
...
_arra = ["USP_GPNVG18_TAN", 0.25, "USP_PVS31", 0.50, "USP_PVS31_COMPACT", 0.50, "USP_PVS31_HIGH", 0.50, "USP_PVS31_LOW", 0.25, "USP_PVS15", 0.75] call BIS_fnc_selectRandomWeighted;
