class WoodlandLoadoutUI
{
	...
	class controls
	{
		...
		class RscButton_1604: RscButton
		{
			...
			colorBackground[] = {0.1,0.1,0.1,1};
			sizeEx = 0.06;
			action = "remoteExec ['RGT_fnc_MedATAmmoBearerwd', player, false]";
		};
		class RscButton_1605: RscButton
		{
			...
			colorBackground[] = {0.1,0.1,0.1,1};
			sizeEx = 0.06;
			action = "remoteExec ['RGT_fnc_Mortar_bipodwd', player, false]";
		};
		class RscButton_1606: RscButton
		{
			...
			colorBackground[] = {0.1,0.1,0.1,1};
			sizeEx = 0.06;
			action = "remoteExec ['RGT_fnc_Mortar_tubewd', player, false]";
		};
		class RscButton_1609: RscButton
		{
			...
			colorBackground[] = {0.1,0.1,0.1,1};
			sizeEx = 0.06;
			action = "remoteExec ['RGT_fnc_AntiAirwd', player, false]";
		};
