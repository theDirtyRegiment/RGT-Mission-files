...
comment "Add weapons";
_rifle = ["rhs_weap_g36kv_ag36", 0.70, "rhs_weap_vhsd2_bg", 0.10] call BIS_fnc_selectRandomWeighted;
...
_vest = ["milgp_v_marciras_grenadier_rgr", 0.05, "milgp_v_marciras_grenadier_belt_rgr", 0.05] call BIS_fnc_selectRandomWeighted;
