...
_optic = ["rhsusf_acc_EOTECH", 0.10, "rhsusf_acc_eotech_xps3", 0.10, "rhsusf_acc_t1_high", 0.05, "rhsusf_acc_g33_xps3_tan", 0.65, "optic_mrco", 0.10] call BIS_fnc_selectRandomWeighted;
...
_array = ["milgp_v_mmac_teamleader_belt_MC", "milgp_v_mmac_teamleader_MC", "milgp_v_jpc_TeamLeader_mc", "milgp_v_jpc_teamleader_belt_mc", "USP_CRYE_JPC_TLB", "USP_CRYE_JPC_TL", "USP_CRYE_CPC_LEAD_BELT_MC", "USP_CRYE_CPC_LEAD_MC", "USP_VEST_STRANDHOGG2_MC", "USP_VEST_PLATEFRAME_LOAD2_MC"];
